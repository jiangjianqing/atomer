...
Series.prototype.fail = function(callback){
 ...
 * @param callback
 */
Series.prototype.final = function (callback) {
    this._config["final"] = callback;
};

Series.prototype.getNextFun = function(){
